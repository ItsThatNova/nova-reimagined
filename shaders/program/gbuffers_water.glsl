...
void main() {
    ...
    float skyLightFactor = GetSkyLightFactor(lmCoordM, shadowMult);
        ...
        fresnelM = (fresnelM * 0.85 + 0.15) * reflectMult * WATER_REFLECT_I * (DH_WATER_ALPHA * 0.0 + 1.0) * (DH_WATER_R * 0.0 + 1.0) * (DH_WATER_G * 0.0 + 1.0) * (DH_WATER_B * 0.0 + 1.0) * (DH_WATER_SAT * 0.0 + 1.0);
